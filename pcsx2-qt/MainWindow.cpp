...
void MainWindow::connectSignals()
{
	...
	connect(m_ui.actionOSDSettings, &QAction::triggered, [this]() { doSettings(SettingsDialog::Category::OSDSettings); });
	...
	connect(m_ui.actionControllerSettings, &QAction::triggered,
		[this]() { doControllerSettings(ControllerSettingsDialog::Category::FirstControllerSettings); });
	connect(m_ui.actionMemoryCardSettings, &QAction::triggered,
		[this]() { doControllerSettings(ControllerSettingsDialog::Category::FirstMemoryCardSettings); });
